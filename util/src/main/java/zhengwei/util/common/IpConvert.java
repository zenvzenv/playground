...
public final class IpConvert {
    ...
    public static void main(String[] args) {
        ...
        String s = "fe80::8984:de33:85aa:5b81";
        String[] ss = s.split(":");
        for (String value : ss) {
            System.out.println(value);
        }

        System.out.println(stringToBigInt("2001:0db8:3c4d:0015:0000:0000:1a2f:1a2b"));
        System.out.println(stringToBigInt("2001:0db8:3c4d:0015:0000:0000:1a2f:1a2b").longValue());
        System.out.println(new BigInteger("47924930447697905117408201437964402688"));
        System.out.println(new BigInteger("47924930447697905117408201437964402688").longValue());
