...
public class HttpAPIClient {
    ...
    public static String getUserLocation(String userIp){
        ...
        url += "&co=&resource_id=6006&t=1433920989928&ie=utf8&oe=utf8&format=json";
...
//    	String s=getUserLocation("140.143.109.2");
    	/*System.out.println(s);
    	JSONObject json=(JSONObject) JSONObject.parse(s);
    	JSONArray data=(JSONArray) json.get("data");
    	...
    	System.out.println(location);
    	System.out.println(s);*/
    	String s=doGet("http://api.map.baidu.com/geocoder/v2/?callback=renderReverse&location=118.3771586272,31.3011829232&output=json&pois=1&ak=OGQEuDKMDZePezskhfve0g42BoKxcvVB&sn=4IOQBszRxvfXyhBhe9n5c0ryRZTNGpIG");
    	System.out.println(s);
    }
}
